 ...
 */
static __rte_always_inline int
rte_strieq15_or_less(const void *dst, const void *src, ng_size_t len)
{
  ...
  s1 = (const ng_uint8_t *)dst;
  s2 = (const ng_uint8_t *)src;
  do {
    c1 = *s1++;
    c2 = *s2++;
    if (!c1 || !c2)
...
rte_strieq32(const ng_uint8_t *dst, const ng_uint8_t *src)
{
  ...
  int ret;
  ret = rte_strieq16((const ng_uint8_t *)dst + 0, (const ng_uint8_t *)src + 0);
  if (!ret) return ret;
  return rte_strieq16((const ng_uint8_t *)dst + 16, (const ng_uint8_t *)src + 16);
#endif
}
...
rte_strieq64(const ng_uint8_t *dst, const ng_uint8_t *src)
{
  ...
  int ret;
  ret = rte_strieq32((const ng_uint8_t *)dst + 0 * 32, (const ng_uint8_t *)src + 0 * 32);
  if (!ret) return ret;
  return rte_strieq32((const ng_uint8_t *)dst + 1 * 32, (const ng_uint8_t *)src + 1 * 32);
#endif
}
 ...
 */
static __rte_always_inline int
rte_strieq128blocks(const ng_uint8_t *dst, const ng_uint8_t *src, ng_size_t n)
{
  __m512i zmm0, zmm1, zmm2, zmm3;
 ...
 */
static inline int
rte_strieq512blocks(const ng_uint8_t *dst, const ng_uint8_t *src, ng_size_t n)
{
  __m512i zmm0, zmm1, zmm2, zmm3;
...
static __rte_always_inline int
rte_strieq_generic(const void *dst, const void *src, ng_size_t n)
{
  int ret;
  ng_size_t dstofss;
  ng_size_t bits;
  ...
  if (__rte_constant(n) && n == 32) {
    ret = rte_strieq32((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
    return ret;
  }
  if (n <= 32) {
    rte_prefetch0((const ng_uint8_t *)dst - 16 + n);
    rte_prefetch0((const ng_uint8_t *)src - 16 + n);
    ret = rte_strieq16((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
    if (!ret) return ret;
    if (__rte_constant(n) && n == 16)
      return ret; /* avoid (harmless) duplicate copy */
    ret = rte_strieq16((const ng_uint8_t *)dst - 16 + n,
          (const ng_uint8_t *)src - 16 + n);
    return ret;
  }
  if (__rte_constant(n) && n == 64) {
    ret = rte_strieq64((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
    return ret;
  }
  if (n <= 64) {
    rte_prefetch0((const ng_uint8_t *)dst - 32 + n);
    rte_prefetch0((const ng_uint8_t *)src - 32 + n);
    ret = rte_strieq32((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
    if (!ret) return ret;
    ret = rte_strieq32((const ng_uint8_t *)dst - 32 + n,
  ...
  if (n <= 512) {
    if (n >= 256) {
      ...
      ret = rte_strieq256((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
      if (!ret) return ret;
    ...
    if (n >= 128) {
      ...
      rte_prefetch0(dst + 128);
      rte_prefetch0(src + 128);
      ret = rte_strieq128((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
      if (!ret) return ret;
...
COPY_BLOCK_128_BACK63:
    if (n > 64) {
      rte_prefetch0((const ng_uint8_t *)dst - 64 + n);
      rte_prefetch0((const ng_uint8_t *)src - 64 + n);
      ret = rte_strieq64((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
      if (!ret) return ret;
      ret = rte_strieq64((const ng_uint8_t *)dst - 64 + n,
    ...
    {  
      rte_prefetch0((const ng_uint8_t *)dst - 64 + n);
      rte_prefetch0((const ng_uint8_t *)src - 64 + n);
      return rte_strieq64((const ng_uint8_t *)dst - 64 + n,
            (const ng_uint8_t *)src - 64 + n);
    }
    return 1;
  }
  ...
  if (dstofss > 0) {
    dstofss = 64 - dstofss;
    n -= dstofss;
    rte_prefetch0((const ng_uint8_t *)dst + dstofss);
    rte_prefetch0((const ng_uint8_t *)src + dstofss);
    ret = rte_strieq64((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
    if (!ret) return ret;
   ...
   */
  ret = rte_strieq512blocks((const ng_uint8_t *)dst, (const ng_uint8_t *)src, n);
  if (!ret) return ret;
  bits = n;
  n = n & 511;
  bits -= n;
   ...
   */
  if (n >= 128) {
    ret = rte_strieq128blocks((ng_uint8_t *)dst, (const ng_uint8_t *)src, n);
    if (!ret) return ret;
    bits = n;
    n = n & 127;
    bits -= n;
...
rte_strieq128blocks(const ng_uint8_t *dst, const ng_uint8_t *src, ng_size_t n)
{
  ...
  while (n >= 128) {
    n -= 128;
    rte_prefetch0((const ng_uint8_t *)dst + 128);
    rte_prefetch0((const ng_uint8_t *)src + 128);
...
rte_strieq_generic(const void *dst, const void *src, ng_size_t n)
{
   ...
   */
  if (__rte_constant(n) && n == 32) {
    return rte_strieq32((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
  }
  if (n <= 32) {
    rte_prefetch0((const ng_uint8_t *)dst - 16 + n);
    rte_prefetch0((const ng_uint8_t *)src - 16 + n);
    ...
    if (__rte_constant(n) && n == 16)
      return ret; /* avoid (harmless) duplicate copy */
    if (!ret) return ret;
    return rte_strieq16((const ng_uint8_t *)dst - 16 + n,
        (const ng_uint8_t *)src - 16 + n);
  }
  if (n <= 64) {
    rte_prefetch0((const ng_uint8_t *)dst - 32 + n);
...
COPY_BLOCK_128_BACK31:
    if (n >= 64) {
      rte_prefetch0((const ng_uint8_t *)dst + 64);
      rte_prefetch0((const ng_uint8_t *)src + 64);
      n -= 64;
      ret = rte_strieq64((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
      if (!ret) return ret;
    ...
    if (n > 0) {
      rte_prefetch0((const ng_uint8_t *)dst - 32 + n);
      rte_prefetch0((const ng_uint8_t *)src - 32 + n);
      return rte_strieq32((const ng_uint8_t *)dst - 32 + n,
          (const ng_uint8_t *)src - 32 + n);
    }
    return 1;
  }
   ...
   * Copy 128-byte blocks
   */
  ret = rte_strieq128blocks((const ng_uint8_t *)dst, (const ng_uint8_t *)src, n);
  if (!ret) return ret;
  bits = n;
  n = n & 127;
  bits -= n;
...
{                                                                                            \
    ...
    if (len >= 32 + 16 - offset) {                                                                          \
        while (len >= 32 + 16 - offset) {                                                                   \
          len -= 32;                                                                                      \
          rte_prefetch0((const ng_uint8_t *)dst + 32); \
          rte_prefetch0((const ng_uint8_t *)src + 32); \
          xmm0 = _mm_loadu_si128((const __m128i *)(const void *)((const ng_uint8_t *)src - offset + 0));              \
          xmm1 = _mm_loadu_si128((const __m128i *)(const void *)((const ng_uint8_t *)src - offset + 16));              \
          xmm2 = _mm_loadu_si128((const __m128i *)(const void *)((const ng_uint8_t *)src - offset + 32));              \
...
rte_strieq_generic(const void *dst, const void *src, ng_size_t n)
{
  ...
  if (n <= 32) {
    ...
    if (__rte_constant(n) && n == 16)
      return ret; /* avoid (harmless) duplicate copy */
    return rte_strieq16((const ng_uint8_t *)dst - 16 + n, (const ng_uint8_t *)src - 16 + n);
  }
  if (n <= 64) {
    rte_prefetch0((const ng_uint8_t *)dst + 32);
    rte_prefetch0((const ng_uint8_t *)src + 32);
    ...
    {  
      rte_prefetch0((const ng_uint8_t *)dst - 16 + n);
      rte_prefetch0((const ng_uint8_t *)src - 16 + n);
      ret = rte_strieq16((const ng_uint8_t *)dst + 32, (const ng_uint8_t *)src + 32);
      if (!ret) return ret;
    }
    return rte_strieq16((const ng_uint8_t *)dst - 16 + n, (const ng_uint8_t *)src - 16 + n);
  }
  ...
  if (n <= 512) {
    if (n >= 256) {
      ...
      ret = rte_strieq128((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
      if (!ret) return ret;
      ret = rte_strieq128((const ng_uint8_t *)dst + 128, (const ng_uint8_t *)src + 128);
      if (!ret) return ret;
      src = (const ng_uint8_t *)src + 256;
      dst = (const ng_uint8_t *)dst + 256;
    }
...
COPY_BLOCK_64_BACK15:
  ...
  if (srcofs == 0) {
     ...
     */
    for (; n >= 256; n -= 256) {
      rte_prefetch0((const ng_uint8_t *)dst + 256);
      rte_prefetch0((const ng_uint8_t *)src + 256);
      ret = rte_strieq256((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
      if (!ret) return ret;
      dst = (const ng_uint8_t *)dst + 256;
      src = (const ng_uint8_t *)src + 256;
...
static __rte_always_inline int
rte_strieq_aligned(const void *dst, const void *src, ng_size_t n)
{
  int ret;
  ...
  if (__rte_constant(n) && n == 64) {
    return rte_strieq64((const ng_uint8_t *)dst, (const ng_uint8_t *)src);
  }
  if (n <= 64) {
    rte_prefetch0((const ng_uint8_t *)dst - 32 + n);
    rte_prefetch0((const ng_uint8_t *)src - 32 + n);
...
rte_strieq(const void *dst, const void *src, ng_size_t n)
{
  ...
  if (!(((ng_uintptr_t)dst | (ng_uintptr_t)src) & ALIGNMENT_MASK))
    return rte_strieq_aligned(dst, src, n);
  else
    return rte_strieq_generic(dst, src, n);
}
